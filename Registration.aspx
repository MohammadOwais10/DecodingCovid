...
ControlToCompare="TextBox7" ControlToValidate="TextBox8" ErrorMessage="Password Doesn't 
match" ForeColor="Red" SetFocusOnError="True"></asp:CompareValidator>
      </div> 
...
<%--        <tr>
        <td colspan="2" style="text-align: center; font-size: large; font-weight: 
bold; text-decoration: none;">
    <asp:Button ID="Button1" runat="server" Text="submit"
      onClick ="Button1_Click" style="font-weight: 700; font-size: x-large; color: #006600;" />
    <asp:Label ID="Label1" runat="server"></asp:Label>
 </td>
 </tr>--%>
</asp:Content>
